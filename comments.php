...
<section id="respond" class="respond-form">
	...
	<div class="control-group">
	  <label  class="control-label" for="author"><?php _e("Name","bonestheme"); ?> <?php if ($req) echo "(required)"; ?></label>
	  <div class="controls">
	...
	<div class="control-group">
	  <label class="control-label" for="email"><?php _e("Mail","bonestheme"); ?> <?php if ($req) echo "(required)"; ?></label>
	  <div class="controls">
		  <div class="input-prepend">
	...
	<div class="control-group">
	  <label class="control-label" for="url"><?php _e("Website","bonestheme"); ?></label>
	  <div class="controls">
		  <div class="input-prepend">
	...
	<div class="control-group">
		<label class="control-label" for="comment"><?php _e("Comment","bonestheme"); ?></label>
		<div class="controls">
			<div class="input-prepend">
			<span class="add-on"><i class="icon-pencil"></i></span>
				<textarea name="comment" id="comment" placeholder="<?php _e("Your Comment Here…","bonestheme"); ?>" class="input-xxlarge"></textarea>
			</div>
		</div>
	</div>
